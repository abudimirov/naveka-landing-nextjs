    ...
    return (
        <div className="">
            <Head>
                ...
                <meta name="description" content="Информация о гарантии и сервисе бренда Naveka. " />
            </Head>
            <div className="h-full">
                <Nav />
                <main className="bg-gradient-to-br from-blue-400 to-blue-900 px-4 pb-10">
                    <h1 className="text-4xl font-bold text-center py-10 lg:py-20 text-white">Гарантия и сервис</h1>
                    ...
                    <div className="lg:w-2/3 mx-auto bg-gray-50 rounded flex flex-col items-center">
                        <div className="px-4 py-10 lg:py-20 lg:px-20 flex flex-wrap justify-center">
                            <img src="/warranty.svg" alt="" className="h-24 lg:h-36 lg:w-1/4 mb-10 lg:mb-0" />
